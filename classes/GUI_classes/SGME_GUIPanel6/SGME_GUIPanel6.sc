SGME_GUIPanel6 : SGME_GUIPanelPatchbay {
	...
	makeNodeTable {
		...
		var numRows = 63;
		var panel;
		var forbidenRows = [25, 26] ++ [46] ++ (53..57) ++ (59..62); // Estas filas no se dibujarán ni se instanciarán sus nodos. Conveniente para ahorro de memoria.
	...
	makeRow {|parent, left, top, row, nodeCountHor|
		...
		var spacing = 5.75;
		var numColumns = 67;
		var forbidenColumns = [66]; // Estas columnas no se dibujarán ni se instanciarán sus nodos. Conveniente para ahorro de memoria.
		Platform.case(
			\osx,       { },
			\linux,     { },
